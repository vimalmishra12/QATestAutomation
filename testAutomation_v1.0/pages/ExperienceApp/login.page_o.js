...
module.exports = {
    ...
    //loginPage
    loaderIcon: selectorFile.css.ComproC1.widgets.loaderIcon,
    brandLogo_img: selectorFile.css.ComproC1.loginPage.brandLogo,
    loginPage_title: selectorFile.css.ComproC1.loginPage.login_title,
    email_tbox_lbl: selectorFile.css.ComproC1.loginPage.login_tbox_lbl,
    userName_tbox: selectorFile.css.ComproC1.loginPage.userName_tbox,
    pswrd_tbox_lbl: selectorFile.css.ComproC1.loginPage.pswrd_tbox_lbl,
    password_tbox: selectorFile.css.ComproC1.loginPage.password_tbox,
    togglePasswordVisibility_btn: selectorFile.css.ComproC1.loginPage.loginPassword_eye,
    google_btn: selectorFile.css.ComproC1.loginPage.google_btn,
    googlebtn_icon: selectorFile.css.ComproC1.loginPage.googlebtn_icon,
    facebook_btn: selectorFile.css.ComproC1.loginPage.facebook_btn,
    facebookbtn_icon: selectorFile.css.ComproC1.loginPage.facebookbtn_icon,
    login_btn: selectorFile.css.ComproC1.loginPage.login_btn,
    forgotPassword: selectorFile.css.ComproC1.loginPage.forgotPassword,
    signup: selectorFile.css.ComproC1.loginPage.signup,
    dontHaveAccount_txt: selectorFile.css.ComproC1.loginPage.signup_lbl,
    loginoption_txt: selectorFile.css.ComproC1.loginPage.loginoption_txt,
   // languageSelector_image: selectorFile.css.ComproC1.landingPage.selectedLangImg,
   // languageSelector_dropdown: selectorFile.css.ComproC1.landingPage.languageSelector_dropdown,
    invalidEmail_txt: selectorFile.css.ComproC1.loginPage.invalidEmail_txt,
    loginbtnState:selectorFile.css.ComproC1.loginPage.loginbtnState,
