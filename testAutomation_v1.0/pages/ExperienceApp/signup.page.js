...
module.exports = {
    ...
    createAccountSubTitleTxt: selectorFile.css.ComproC1.signUp.createAccountSubTitleTxt,
    emailLbl: selectorFile.css.ComproC1.signUp.emailLbl,
    emailTextbox: selectorFile.css.ComproC1.signUp.emailTextbox,
    signUpBtn: selectorFile.css.ComproC1.signUp.signUpBtn,
    continueWithTxt: selectorFile.css.ComproC1.signUp.continueWithTxt,
    googleBtn: selectorFile.css.ComproC1.signUp.googleBtn,
    facebookBtn: selectorFile.css.ComproC1.signUp.facebookBtn,
    haveAnAccountTxt: selectorFile.css.ComproC1.signUp.haveAnAccountTxt,
    logInBtn: selectorFile.css.ComproC1.signUp.logInBtn,
    emailErrorTxt: selectorFile.css.ComproC1.signUp.emailErrorTxt,
    roleSelectionTitleTxt: selectorFile.css.ComproC1.signUp.roleSelectionTitleTxt,
    selectRoleTxt: selectorFile.css.ComproC1.signUp.selectRoleTxt,
    studentRoleBtn: selectorFile.css.ComproC1.signUp.studentRoleBtn,
    teacherRoleBtn: selectorFile.css.ComproC1.signUp.teacherRoleBtn,
    continueBtn: selectorFile.css.ComproC1.signUp.continueBtn,
    backToSignInBtn: selectorFile.css.ComproC1.signUp.backToSignInBtn,
    roleSelectionErrorTxt: selectorFile.css.ComproC1.signUp.roleSelectionErrorTxt,
    accountDetailsTitleTxt: selectorFile.css.ComproC1.signUp.accountDetailsTitleTxt,
    emailTxt: selectorFile.css.ComproC1.signUp.emailTxt,
    passwordLbl: selectorFile.css.ComproC1.signUp.passwordLbl,
    passwordTextbox: selectorFile.css.ComproC1.signUp.passwordTextbox,
    passwordHelperTxt: selectorFile.css.ComproC1.signUp.passwordHelperTxt,
    confirmPasswordLbl: selectorFile.css.ComproC1.signUp.confirmPasswordLbl,
    confirmPasswordTextbox: selectorFile.css.ComproC1.signUp.confirmPasswordTextbox,
    passwordToggleBtn: selectorFile.css.ComproC1.signUp.passwordToggleBtn,
    confirmPasswordToggleBtn: selectorFile.css.ComproC1.signUp.confirmPasswordToggleBtn,
    firstNameLbl: selectorFile.css.ComproC1.signUp.firstNameLbl,
    lastNameLbl: selectorFile.css.ComproC1.signUp.lastNameLbl,
    firstNameTextbox: selectorFile.css.ComproC1.signUp.firstNameTextbox,
    lastNameTextbox: selectorFile.css.ComproC1.signUp.lastNameTextbox,
    countryLbl: selectorFile.css.ComproC1.signUp.countryLbl,
    countryTextbox: selectorFile.css.ComproC1.signUp.countryTextbox,
    countryArrowBtn: selectorFile.css.ComproC1.signUp.countryArrowBtn,
    policyLineTxt: selectorFile.css.ComproC1.signUp.policyLineTxt,
    policyLineCheckbox: selectorFile.css.ComproC1.signUp.policyLineCheckbox,
    createAccountBtn: selectorFile.css.ComproC1.signUp.createAccountBtn,
    backToRoleSelectionBtn: selectorFile.css.ComproC1.signUp.backToRoleSelectionBtn,
    passwordErrorTxt: selectorFile.css.ComproC1.signUp.passwordErrorTxt,
    confirmPasswordErrorTxt: selectorFile.css.ComproC1.signUp.confirmPasswordErrorTxt,
    firstNameErrorTxt: selectorFile.css.ComproC1.signUp.firstNameErrorTxt,
    lastNameErrorTxt: selectorFile.css.ComproC1.signUp.lastNameErrorTxt,
    countryErrorTxt: selectorFile.css.ComproC1.signUp.countryErrorTxt,
    policyLineErrorTxt: selectorFile.css.ComproC1.signUp.policyLineErrorTxt,
    privacyPoliceLink: selectorFile.css.ComproC1.signUp.privacyPoliceLink,
    termsOfUseLink: selectorFile.css.ComproC1.signUp.termsOfUseLink,
    privacyPolicyTab: selectorFile.css.ComproC1.signUp.privacyPolicyTab,
    termsOfUseTab: selectorFile.css.ComproC1.signUp.termsOfUseTab,
    policyCancelBtn: selectorFile.css.ComproC1.signUp.policyCancelBtn,
    policyAgreeBtn: selectorFile.css.ComproC1.signUp.policyAgreeBtn,
    policyCrossBtn: selectorFile.css.ComproC1.signUp.policyCrossBtn,
    googlePageHeadingTxt: selectorFile.css.ComproC1.signUp.googlePageHeadingTxt,
    googlePageSubHeadingTxt: selectorFile.css.ComproC1.signUp.googlePageSubHeadingTxt,
    facebookPageHeadingTxt: selectorFile.css.ComproC1.signUp.facebookPageHeadingTxt,
    countryList: selectorFile.css.ComproC1.signUp.countryList,
    countryItem: selectorFile.css.ComproC1.signUp.countryItem,
    progressBar: selectorFile.css.ComproC1.onboarding.progressBar,
    ...
    isInitialized: async function () {
       // var res;
        ...
        res = {
            pageStatus: await action.waitForDisplayed(this.createAccountTitleTxt, 5000),
