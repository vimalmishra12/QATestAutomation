...
await logger.logInto(await stackTrace.get());
var res;
res =await action.click(this.PracticeExtracqa);
if (true == res) {
...
await logger.logInto(await stackTrace.get());
var res;
res =await action.click(this.LessonA);
if (true == res) {
...
await logger.logInto(await stackTrace.get());
var res;
res =await action.click(this.Next);
if (true == res) {
...
await logger.logInto(await stackTrace.get());
var res;
res =await action.click(this.setDate);
if (true == res) {
...
await logger.logInto(await stackTrace.get());
var res;
res =await action.click(this.selectStudent);
if (true == res) {
...
await logger.logInto(await stackTrace.get());
var res;
res =await action.click(this.ViewSummary);
if (true == res) {
...
await logger.logInto(await stackTrace.get());
var res;
res =await action.click(this.Assign);
if (true == res) {
