...
module.exports = {
  ...
  nextBtn: selectorFile.css.ComproC1.c1student.nextBtn,
  greenBtn: selectorFile.css.ComproC1.c1student.greenBtn,
  activityIFrame: selectorFile.css.ComproC1.hyperLinkAnswerWindow.activityIFrame,
  activityScoreCheck: selectorFile.css.ComproC1.hyperLinkAnswerWindow.activityScoreCheck,
  activityAnsElement: selectorFile.css.ComproC1.hyperLinkAnswerWindow.activityAnsElement,
  ...
  click_closeSideBar: async function () {
    ...
    if (true == res) {
      ...
      await action.click(this.greenBtn);
      await browser.pause(4000) ; 
